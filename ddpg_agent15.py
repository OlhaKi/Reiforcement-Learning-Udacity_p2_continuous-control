...
class Agent():
    def __init__(self, state_size, action_size, random_seed=10,
        ...
        print("\nDDPG Agent Constructor 16 (parameters):\n\n state_size={} action_size={} random_seed={} actor_fc1_units={} actor_fc2_units={} critic_fcs1_units={} critic_fc2_units={} buffer_size={} batch_size={} gamma={} tau={} lr_actor={} lr_critic={} weight_decay={} add_ounoise={} mu={} theta={} sigma={} \n".format(state_size, action_size, random_seed, 
